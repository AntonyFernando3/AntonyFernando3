...
###
<h2 data-importer="text" align="left">Linguagens de Programação & Banco de Dados</h2>
...
###
<h2 data-importer="text" align="left">Softwares de Programação</h2>
<div data-importer="techs" align="left">
...
###
<h2 data-importer="text" align="left">Tecnologias Digitais</h2>
<div data-importer="techs" align="left">
...
###
<h2 data-importer="text" align="left"> Ferramentas Microsoft Office e Google Workspace </h2>
<br>
...
###
<h2 data-importer="text" align="left"> Ferramentas de Simulação </h2>
<br>
...
###
<h2 data-importer="text" align="center">------------------------------ FORMAÇÕES E CERTIFICAÇÕES ------------------------------</h2>
<br>

<h2 data-importer="text" aling="left"> Graduações </h2>
Tecnologo em Análise e Desenvolvimento de Sistemas - Faculdade de Tecnologia de Jundiaí <br>
Bacharelado em Tecnologia da Informação - Universidade Virtual de São Paulo <br>
<br>

<h2 data-importer="text" aling="left"> Cursos Técnicos </h2>
Desenvolvimento Web Java - Senac Lapa Tito <br>
Proprofissão - Instituto Proa <br>
<br>

<h2 data-importer="text" aling="left"> Cursos Profissionalizantes </h2>
Informática - Escola Modelo <br>
Manutenção de Computadores - Escola Modelo <br>
Design Gráfico - Fiap On <br>
Java Development - Fiap On <br>
Python - Fiap On <br>
User Experience - Fiap One <br>
<br>

<h2 data-importer="text" aling="left"> Cursos de formação continuada </h2>
Rede de Computadores Implantação de Redes Locais - Senai Osasco <br>
Implantação de Serviços em Nuvem Google Cloud Engineer - Senai Osasco <br>
Implantação de Serviços em Nuvem Google Cloud Foundations - Senai Osasco <br>
Implantação de Serviços de Inteligência Artificial em Nuvem Google Cloud AI Foundations - Senai Osasco <br>
Tecnologia da Informação e Comunicação - Senai Tecnologias Educacionais <br>
Logica de Programação - Senai Tecnologias Educacionais <br>

<br>
<h2 data-importer="text" aling="left"> Bootcamps </h2>
Sistemas Operacionais - Fundação Bradesco <br>
HTML Avançado - Fundação Bradesco <br>
Ferramentas Digitais - Recode <br>
Programação App Inventor - Recode <br>
Bootcamp de Produção de Redação Letrus - Instituto Proa <br>
Bootcamp de Comunicação e Expressão - Instituto Proa <br>
Bootcamp de Análise de Dados Oracle - Instituto Proa <br>
Bootcamp de Educação Financeira C6 Bank Institute - Instituto Proa <br>
...
<picture data-importer="pacman">
  ...
  <img alt="pacman contribution graph" src="https://raw.githubusercontent.com/AntonyFernando3/AntonyFernando3/pacman-output/pacman-contribution-graph.svg?game=pacman">
</picture>
